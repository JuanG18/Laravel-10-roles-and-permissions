...
class FormularioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'recurso_humano' => 'required', // Agregar validación para recurso humano
            'herramientas' => 'required', // Agregar validación para herramientas
            'registros_vitales' => 'required', // Agregar validación para registros vitales
            'recomendaciones_recuperacion' => 'required', // Agregar validación para recomendaciones de recuperación
        ]);
